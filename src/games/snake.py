...
class Game:
	...
	def update(self):
		...
		if   self.dir == DIR_UP: head.y -= 1
		elif self.dir == DIR_DOWN: head.y += 1
		elif self.dir == DIR_LEFT: head.x -= 1
		elif self.dir == DIR_RIGHT: head.x += 1
...
if __name__ == "__main__":
	game = Game()
	game.run()
	game.sense.show_message(f"Score: {self.score}")